...
@pytest.fixture
def category_1():
    product1 = Product(name="Samsung Galaxy S23 Ultra", description="Смартфон", price=180000, quantity=5)
    product2 = Product(name="Iphone 15", description="Смартфон Apple", price=150000, quantity=3)
    product3 = Product(name="Xiaomi Redmi Note 11", description="Бюджетный смартфон", price=25000, quantity=10)
    return Category(
        "Смартфоны",
...
@pytest.fixture
def category_2():
    product1 = Product(name='55" QLED 4K', description="Телевизор с QLED-экраном", price=80000, quantity=2)
    return Category(
        "Телевизоры",
